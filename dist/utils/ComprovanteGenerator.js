...
exports.ComprovanteGenerator = void 0;
const Produto_1 = require("../models/Produto");
class ComprovanteGenerator {
    static gerarComprovante(pedido, cliente) {
...
╠══════════════════════════════════════════════════════════════`;
        ...
        pedido.itens.forEach((item, index) => {
            const produto = Produto_1.ProdutoModel.buscarPorId(item.produtoId);
...
╚══════════════════════════════════════════════════════════════`;
    ...
    static salvarComprovante(comprovante, nomeArquivo) {
        const fs = require('fs');
...
exports.ComprovanteGenerator = ComprovanteGenerator;
//# sourceMappingURL=ComprovanteGenerator.js.map